...
if len(filelist) > 1: # More than one file to combine
    ...
    # number in filename and then move to the maximum number in the filename
    
else:
    print "Only one or no mp4 file here. Cant combine the data."
